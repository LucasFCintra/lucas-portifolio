...
const about = {
  ...
  info: [
    {
      fieldName: 'Nome',
      fieldValue: 'Lucas Cintra'
    },
    {
      fieldName: 'Telefone',
      fieldValue: '(+55) 16 90000-0000'
    },
    {
      fieldName: 'Email',
          ...
          <div className='min-h-[70vh] w-full'>
            ...
            <TabsContent value='experience' className='w-full'>
              <div className='flex flex-col gap-[30px] text-center xl:text-left'>
                ...
                <p className='max-w-[600px] text-white/60 mx-auto xl:mc-0'>{experience.description}</p>
            ...
            <TabsContent value='skills' className='w-full h-full'>
              <div className='flex flex-col gap-[30px]'>
                    <div className='flex flex-col gap-[30px] text-center xl:text-left'>
                      ...
                      <p className='max-w-[600px] text-white/60 mx-auto xl:mc-0'>{skills.description}</p>
                    </div>
                    <ul className='grid grid-cols-2 sm:gri-cols-3 md:grid-cols-4 gap-4 xl:gap-[30px]'>
